...
function menu() {
    ...
    for(let i = 0; i < $(".nav_service_item").length; i++){
        $(".nav_service_item").eq(i).mouseenter(()=>{
            $(".nav_service_item_postion").hide();
            $(".nav_service_item_postion").eq(i).show();
        }).mouseleave(()=>{
            $(".nav_service_item_postion").eq(i).hide();
        });
    }
